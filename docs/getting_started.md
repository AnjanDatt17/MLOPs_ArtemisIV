# Getting Started with Movie Recommendation
...
**Using conda:**
```bash
conda create -n teamartemisIV python=3.11
conda activate teamartemisIV
```
...
```bash
python -m teamartemisIV.predict_model --model-path models/model.pkl --input data/test.csv
```
...
pytest tests/ --cov=teamartemisIV
...
├── src/
│   └── teamartemisIV/          # Importable package (src/ layout)
...
- Contact Your name (or your team name) (your.email@depaul.edu)
